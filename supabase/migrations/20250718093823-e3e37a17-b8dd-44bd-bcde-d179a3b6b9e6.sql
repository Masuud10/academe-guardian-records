-- Drop the existing function with old parameter names
DROP FUNCTION IF EXISTS public.create_comprehensive_school(text,text,text,text,text,text,text,integer,text,text,text,text,text,text,text,text,text,text,text,text);
